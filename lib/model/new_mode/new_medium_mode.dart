...
import 'package:xo_game/model/new_mode/game_page_med.dart';
import 'package:flutter_colorpicker/flutter_colorpicker.dart';

class NewMediumModePage extends StatefulWidget {
  const NewMediumModePage({super.key});

  @override
  State<NewMediumModePage> createState() => _NewMediumModePageState();
}

class _NewMediumModePageState extends State<NewMediumModePage> {
