...
import 'package:xo_game/model/new_mode/game_page_easy.dart';
import 'package:flutter_colorpicker/flutter_colorpicker.dart';

class NewEasyModePage extends StatefulWidget {
  const NewEasyModePage({super.key});

  @override
  State<NewEasyModePage> createState() => _NewEasyModePageState();
}

class _NewEasyModePageState extends State<NewEasyModePage> {
