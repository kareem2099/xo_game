...
import 'package:xo_game/model/classic_mode/game_page_mid.dart';
import 'package:flutter_colorpicker/flutter_colorpicker.dart';

class ClassicMediumModePage extends StatefulWidget {
  const ClassicMediumModePage({super.key});

  @override
  State<ClassicMediumModePage> createState() => _ClassicMediumModePageState();
}

class _ClassicMediumModePageState extends State<ClassicMediumModePage> {
